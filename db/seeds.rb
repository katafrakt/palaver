...
th1 = start_thread.(title: "Topic 1", category_id: test.id, content: "test", author: john)
reply_in_thread.(thread: th1, author: martha, content: "this is a longer reply to a previous message")
reply_in_thread.(thread: th1, author: john, content: Faker::Lorem.paragraphs(number: 5).join(" "))
start_thread.(title: "Topic 2", category_id: test.id, content: "test", author: john)
